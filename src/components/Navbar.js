   ...
   <nav className='navbar'>
    <div className='main-nav-box'>
     ...
     <div className="nav-items-box">
            <Link
              className={`nav-item-1 nav-item ${activeNavItem === 'Home' ? 'nav-item-active' : ''}`}
              to="/"
            ...
            <Link
              className={`nav-item-2 nav-item ${activeNavItem === 'Movies' ? 'nav-item-active' : ''}`}
              to="/movies"
            ...
            <Link
              className={`nav-item-3 nav-item ${activeNavItem === 'TV Shows' ? 'nav-item-active' : ''}`}
              to="/tvshows"
            ...
            <Link
              className={`nav-item-4 nav-item ${activeNavItem === 'Series' ? 'nav-item-active' : ''}`}
              to="/series"
